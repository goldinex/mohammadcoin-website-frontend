...
export default function WhyUs() {
  ...
  return (
    <section className="py-16 px-4 bg-white" dir="rtl">
        ...
        {features.map((item) => (
          ...
          >
            ...
            <div className="flex flex-col text-right md:text-center md:mt-2 flex-1">
              {/* عنوان */}
              <h3 className="text-[11px] lg:text-base font-semibold text-gray-800 mb-1 md:mb-2 md:min-h-[48px]">
                {item.title}
              </h3>
              {/* توضیح */}
      ...
      <p className="text-gray-700 text-[10px] lg:text-[18px] md:text-base leading-8 mt-8 lg:mt-14 text-right px-4 lg:px-28">
        علاوه بر خرید، سکه محمد امکان فروش اینترنتی سکه طلا/شمش/پارسیان را نیز
        برای کاربران فراهم کرده است. اگر قصد فروش سکه‌های خریداری شده از این پلتفرم را دارید،
        می‌توانید با قیمت مناسب و بدون واسطه در کمترین زمان معامله خود را انجام
        دهید. این ویژگی باعث می‌شود که بازار سکه همیشه در دسترس و شفاف باشد.
      </p>
    </section>
  );
}
