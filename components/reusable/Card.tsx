  ...
  return (
    <div className='bg-primary-210 rounded-[10px] p-4'>
      ...
      <div className='mt-4 flex items-center justify-between'>
        ...
        <button className=' text-center px-12 py-2 text-[16px] rounded-[20px] bg-[#96A375] text-white'>
          خرید
        </button>
      </div>
    </div>
    ...
    <section dir='rtl' className='w-full mt-40 py-10'>
      ...
      <div className='flex justify-center mt-6'>
        {hasMore && (
          <button
            onClick={() =>
              setVisibleCount((c) => Math.min(c + 3, allItems.length))
            }
